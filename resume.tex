...
\section{Work Experience}
  \begin{itemize}[leftmargin=*, label={}]
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Migrated legacy services to modern architecture, reducing system complexity by 40\% and improving P99 latency by 11ms while maintaining 95\%+ code coverage through comprehensive unit and integration testing}
        \resumeItem{Developed IoT integration platform with webhook APIs and automated control systems, reducing manual operational interventions by 80\% and improving system reliability to 99.9\% uptime}
      \resumeItemListEnd
    \resumeSubheading
